# RapidCheck property-based testing for Verium Core

## Concept

Property-based testing is experimentally being added to Verium Core with
...
If RapidCheck is installed, Verium Core will automatically run the
...
3. Configure Verium Core with RapidCheck.
...
4. Build Verium Core with RapidCheck.
...
That's it! You are now running property-based tests in Verium Core.
