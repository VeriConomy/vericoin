...
This document provides guidelines for internationalization of the Vericoin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vericoin_en.ts` remains unchanged.
