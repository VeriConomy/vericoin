...
* vericoin.conf: contains configuration settings for vericoind or vericoin-qt
* vericoind.pid: stores the process id of vericoind while running
...
* debug.log: contains debug information and general logging generated by vericoind or Vericoin-qt
