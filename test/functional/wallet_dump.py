...
def read_dump(file_name, addrs, script_addrs, hd_master_addr_old):
    ...
    with open(file_name, encoding='utf8') as inputfile:
        ...
        return found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, hd_master_addr_ret
...
class WalletDumpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, hd_master_addr_unenc = \
        ...
        found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, _ = \
