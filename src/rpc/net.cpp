...
static UniValue getpeerinfo(const JSONRPCRequest& request)
{
            ...
            "    \"subver\": \"/Vericoin:0.8.5/\",  (string) The string version\n"
    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw std::runtime_error(
            RPCHelpMan{"addnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:58684\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:58684\", \"onetry\"")
                },
            }.ToString());
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
            RPCHelpMan{"disconnectnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:58684\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:58684\"")
...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:58684\",  (string) The vericoin server IP and port we're connected to\n"
...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
            ...
            "  \"subversion\": \"/Vericoin:x.x.x/\",     (string) the server subversion string\n"
