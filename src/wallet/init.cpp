...
{
    gArgs.AddArg("-addresstype", strprintf("What type of addresses to use (\"legacy\") default: \"%s\")", FormatOutputType(DEFAULT_ADDRESS_TYPE)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-changetype", "What type of change to use (\"legacy\"). Default is same as -addresstype", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-paytxfee=<amt>", strprintf("Fee (in %s/kB) to add to transactions you send", CURRENCY_UNIT), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
