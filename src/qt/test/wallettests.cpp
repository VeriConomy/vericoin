...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_verium-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_verium-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_verium-qt  # macOS
void TestGUI()
{
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_verium-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
