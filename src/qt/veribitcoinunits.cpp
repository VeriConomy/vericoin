...
QString veriBitcoinUnits::formatMaxDecimals(int unit, qint64 n, int decimals, bool fPlus)
{
...
QString veriBitcoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign)
{
    return format(unit, amount, plussign) + QString(" ") + name(unit);
}

// Calling this function with maxdecimals(unit) will return the maximum number of decimals.
QString veriBitcoinUnits::formatWithUnitWithMaxDecimals(int unit, qint64 amount, int decimals, bool plussign)
{
