    ...
    filter(0)
{
    ...
    ui->listTransactions->setStyleSheet("QListView { background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #fafbfe, stop: 1 #ECF3FA); color: " + STRING_VERIFONT + "; border-radius: 10px; border: 0; padding-right: 10px; padding-bottom: 5px; } \
