...
Represents the main window of the Vericoin UI.
...
* `bitcoinunits.(h/cpp)`: VRC / mVRC / etc handling
* `callback.h`
...
10. Start debugging with Qt Creator (you might need to the executable to "vericoin-qt" under "Run", which is where you can also add command line arguments)
