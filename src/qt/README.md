...
Represents the main window of the Verium UI.
...
* `bitcoinunits.(h/cpp)`: VRM / mVRM / etc handling
* `callback.h`
...
10. Start debugging with Qt Creator (you might need to the executable to "verium-qt" under "Run", which is where you can also add command line arguments)
