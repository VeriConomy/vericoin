        ...
        QWidget(parent), amount(0), currentUnit(-1)
{
    ...
    unit->setModel(new BitcoinUnits(this, NULL));
...
{
    setText(BitcoinUnits::formatMaxDecimals(currentUnit, value, BitcoinUnits::maxdecimals(currentUnit), false, false, false));
}
