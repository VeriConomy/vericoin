...
def main():
    ...
    # Filter out hosts with multiple vericoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple vericoin ports' % (ip_stats(ips)), file=sys.stderr)
